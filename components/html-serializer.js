  ...
  switch(type) {
    ...
    case Elements.image: // Image
      ...
      const caption = React.createElement(
        'div',
        propsWithUniqueKey({ className: 'caption' }, key),
        element.alt || ''
      );
      
      let childElements = [imageElement, caption];

      return React.createElement('div', propsWithUniqueKey({className: 'inline-image'}, key), childElements)
