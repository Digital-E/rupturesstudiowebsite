                ...
                <Socials>
                    ...
                    <Icons>
                        <Link data={data[0].node.insta_link}>
                            ...
                            <g>
                                <path class="st0" d="M5.96,7.37C5.99,7.6,6.02,7.74,6.05,7.78C6.3,8.34,6.71,8.62,7.26,8.62c0.7,0,1.12-0.43,1.25-1.29
                        ...
                        <Link data={data[0].node.facebook_link}>
                            <svg height="50px" x="0px" y="0px"
                                viewBox="0 0 14.62 14.51">
                            <g>
                                <path class="st0" d="M6.3,4.04C6.6,3.32,7.22,2.96,8.18,2.96H8.4c0.58,0,0.88,0.04,0.88,0.12v1.25H8.44
